...
public class AgencyMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        agencyMarketingChannel = findViewById(R.id.agency_marketing_channel);
        ...
        tvViewOrderHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AgencyMainActivity.this, AgencyOrderActivity.class);
        ...
        llMyProducts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AgencyMainActivity.this, AgencyProductActivity.class);
                startActivity(intent);
            }
        });
        ...
        llFinance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AgencyMainActivity.this, FinanceActivity.class);
                startActivity(intent);
            }
        });
        ...
        llSalesPerformance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AgencyMainActivity.this, AgencySalesPerformanceActivity.class);
                startActivity(intent);
            }
        });

        agencyMarketingChannel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Intent intent = new Intent(AgencyMainActivity.this, ShopManagementActivity.class);
                // startActivity(intent);
            }
        });
        ...
        llShopeeAds.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AgencyMainActivity.this, AgencyCreateCouponActivity.class);
                startActivity(intent);
            }
        });
...
//                 startActivity(intent);
        ...
        if (imgShopLogo != null) {
            imgShopLogo.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(AgencyMainActivity.this, ProfileActivity.class);
                    startActivity(intent);
                }
            });
        }
