...
public class OrderSellerAdapter extends RecyclerView.Adapter<OrderSellerAdapter.OrderSellerViewHolder> {
    ...
    public OrderSellerAdapter(List<Order> orderList, OnOrderActionButtonClickListener listener) {
    ...
    @NonNull
    @Override
    public OrderSellerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_oder_seller, parent, false);
        return new OrderSellerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OrderSellerViewHolder holder, int position) {
        Order order = orderList.get(position);

        if (order.getAddress_info() != null) {
            holder.buyerNameTextView.setText(order.getAddress_info().getFullname());
        } else {
            holder.buyerNameTextView.setText("Không có thông tin người mua");
        }
    ...
    public static class OrderSellerViewHolder extends RecyclerView.ViewHolder {
        ImageView userAvatar, productImage;
        TextView buyerNameTextView, orderStatusTextView, orderCodeTextView, orderDateTextView;
        ...
        public OrderSellerViewHolder(@NonNull View itemView) {
            super(itemView);
