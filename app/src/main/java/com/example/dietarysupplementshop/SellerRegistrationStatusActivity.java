...
public class SellerRegistrationStatusActivity extends AppCompatActivity {
    private static final String TAG = "SellerRegStatusActivity";
    ...
    // Khai báo nút mới
    private Button btnGoToHomepage, btnGoToSellerChannel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "SellerRegistrationStatusActivity created, loading account info.");
    }
    ...
    private void setupClickListeners() {
        ...
        btnGoToSellerChannel.setOnClickListener(v -> {
            Log.d(TAG, "Go To Seller Channel button clicked. Acknowledging approval.");
