...
public class AccountInformation {
    ...
    private String rejectionReason; // Đã có

    public AccountInformation() {
    }

    public AccountInformation(long id, String rejectionReason,String avatar_url, String role_code, String status,CartInformation cart_info, AccountProfile accountProfileDTO) {
        this.id = id;
