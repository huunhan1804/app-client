...
public class ProductVariantDTO {
    ...
    public ProductVariantDTO(Long product_variant_id, String product_variant_name, String product_variant_image_url, String origin_price, String sale_price, int quantity_in_stock, int sold_amount) {
    ...
    public void setSold_amount(int soldAmount) {
        this.sold_amount = soldAmount;
    }
}
