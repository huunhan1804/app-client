...
public class AgencyIdentifierInformationRegistrationActivity extends AppCompatActivity {
    ...
    private void setupListeners() {
        ...
        findViewById(R.id.btn_next).setOnClickListener(v -> {
            if (validateAndCollectData()) {
                Intent intent = new Intent(this, AgencyCertificatesInformationRegistrationActivity.class);
    ...
    private boolean validateAndCollectData() {
        agencyRegistrationData.setFullName(Objects.requireNonNull(etFullName.getText()).toString().trim());
        agencyRegistrationData.setDateOfBirth(Objects.requireNonNull(etDateOfBirth.getText()).toString().trim());
        agencyRegistrationData.setGender(actvGender.getText().toString().trim());
        agencyRegistrationData.setIdCardNumber(Objects.requireNonNull(etIdCardNumber.getText()).toString().trim());
        agencyRegistrationData.setDateOfIssue(Objects.requireNonNull(etDateOfIssue.getText()).toString().trim());
        agencyRegistrationData.setPlaceOfIssue(Objects.requireNonNull(etPlaceOfIssue.getText()).toString().trim());
