...
public class SellerOverviewFragment extends Fragment {

    private Calendar startCalendar, endCalendar;

    public SellerOverviewFragment() {
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_seller_overview, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView tvSelectedTimeFrameSales = view.findViewById(R.id.tv_selected_time_frame_sales);
        tvSelectedTimeFrameSales.setOnClickListener(v -> showTimeFrameSelectionDialog(tvSelectedTimeFrameSales));
        ...
        tvSelectedTimeFrameSales.setText("7 ngày qua");
    }
                ...
                (view, year, month, dayOfMonth) -> {
                    ...
                    DatePickerDialog endDatePickerDialog = new DatePickerDialog(getContext(),
                            (view1, year1, month1, dayOfMonth1) -> {
                                ...
                                targetTextView.setText(dateRange); // Cập nhật TextView
    ...
    private void loadDataForSelectedTimeFrame(String timeFrame) {
        ...
        Toast.makeText(getContext(), "Tải dữ liệu cho: " + timeFrame, Toast.LENGTH_SHORT).show();
        // TextView tvTotalRevenue = getView().findViewById(R.id.tv_total_revenue);
        // if (tvTotalRevenue != null) {
        //     tvTotalRevenue.setText("Dữ liệu mới dựa trên " + timeFrame);
        // }
    }

    private void loadDataForCustomRange(Date startDate, Date endDate) {
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy", Locale.getDefault());
        Toast.makeText(getContext(), "Tải dữ liệu từ " + sdf.format(startDate) + " đến " + sdf.format(endDate), Toast.LENGTH_SHORT).show();
    }
}