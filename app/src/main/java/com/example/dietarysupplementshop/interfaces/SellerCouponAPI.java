...
public interface SellerCouponAPI {
    ...
    Call<ResponseModel<List<Coupon>>> getSellerCoupons(@Query("status") String status); // status: ACTIVE, INACTIVE, EXPIRED, ALL
    ...
    @PUT("api/seller/coupons/{couponId}/status")
