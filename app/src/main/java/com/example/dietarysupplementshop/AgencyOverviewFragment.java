...
public class AgencyOverviewFragment extends Fragment {

    private Calendar startCalendar, endCalendar;

    public AgencyOverviewFragment() {
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_agency_overview, container, false);
    }
