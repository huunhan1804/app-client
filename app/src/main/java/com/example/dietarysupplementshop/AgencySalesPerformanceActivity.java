...
public class AgencySalesPerformanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapter.addFragment(new AgencyOverviewFragment(), "Tổng quan");
        viewPagerAdapter.addFragment(new AgencyOverviewProductsFragment(), "Sản phẩm");
