...
public class CreateVoucherRequest implements Serializable {
    private String couponCode; // Mã voucher, nếu có
    private BigDecimal discountValue;
    private String discountType; // "AMOUNT" hoặc "PERCENTAGE"
    private Date expiryDate;
    private Boolean isActivated; // Thường là true khi tạo
    private Integer remainingQuantity;
    private BigDecimal minPurchaseAmount;
    private Integer minQuantity; // Cho voucher sản phẩm theo số lượng
    private Integer maxQuantity; // Cho voucher sản phẩm theo số lượng hoặc mức giảm tối đa
    private String description;
    private String couponType; // "SHIPPING" hoặc "DISCOUNT"
    private Long categoryId;
    private String shippingMethod; // Nếu là SHIPPING voucher
    private List<Long> productIds; // Nếu là DISCOUNT voucher áp dụng cho sản phẩm cụ thể
